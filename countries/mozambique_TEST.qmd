---
title: "Mozambique Malaria Epidemiology Summary"
format: html
---
...
epi_data <- read.xlsx("../submissions/mozambique/epi_table_TEMPLATE_v1.xlsx", sheet = "Data")
...
![**Figure:**](../submissions/mozambique/Images/Mozambique_StudyArea_Map.png)
...
![**Figure:**](../submissions/mozambique/Images/figure_04_timeline.png)
...
![**Figure:**](../submissions/mozambique/Images/MozambiqueHS-diagram.png)
...
![**Figure:**](../submissions/mozambique/Images/Mozambique data Flow.png)
...
![**Figure:**](../submissions/mozambique/Images/12_facilities_by_province_summary.png)
...
![**Figure:**](../submissions/mozambique/Images/12_facilities_points_map.png)
...
![**Figure:**](../submissions/mozambique/Images/incidencemza.jpg)
...
![**Figure:**](../submissions/mozambique/Images/malaria deaths.jpg)
**Figure 8:** Malaria deaths trend at district level 

**Source:** National Malaria Strategic Plan (NMSP) of Mozambique: 2023 – 2030 https://mesamalaria.org/resource-hub/national-malaria-strategic-plan-nmsp-of-mozambique-2023-2030/

![**Figure:**](../submissions/mozambique/Images/interventionsmza.jpg)
...
![**Figure:**](../submissions/mozambique/Images/06_province_prevalence_map.png)
**Figure 10** Province prevalence of Children 6-59 months, household survey.

**Source:** STATcompiler https://www.statcompiler.com

![**Figure:**](../submissions/mozambique/Images/06_province_prevalence_summary.png)
...
![**Figure:**](../submissions/mozambique/Images/11_rainfall_climatology.png)
...
![**Figure:**](../submissions/mozambique/Images/12_rainfall_maps.png)
**Figure 13:** Rainfall zones and mean annual rainfall by province, Mozambique

**Source:** NASA POWER, parameter PRECTOTCORR (precipitation corrected, MERRA-2), 30-year climatology January 1991 – December 2020, retrieved at each province's representative interior point via the POWER Climatology API. https://power.larc.nasa.gov/

![**Figure:**](../submissions/mozambique/Images/Screenshot 2025-02-04 120353.png)
...
![**Figure:**](../submissions/mozambique/Images/15_vector_distribution.png)
...
![**Figure:**](../submissions/mozambique/Images/07_province_itn_use_map.png)
**Figure 16:** Population slept under an ITN the previous night, 2011-2023

**Source:** STATcompiler https://www.statcompiler.com

![**Figure:**](../submissions/mozambique/Images/07_province_itn_use_summary.png)
